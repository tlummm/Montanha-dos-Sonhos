**Astúcia** se baseia no uso da **Mana** para tirar vantagem de desinformados, um equilíbrio entre capacidades físicas anormais e manipulações da realidade, enganando e derrotando seus oponentes, sendo extremamente adaptável a diversas situações. 
...
Uma forma educada de pedir silêncio. Realiza um **Ataque** contra o **Oponente**, porém com apenas metade do **Dano**. A ultima **Habilidade** usada por aquele **Alvo** não pode ser usada novamente até o fim do **Combate**. Só uma **Habilidade** por vez pode ser restrita por **Degolar**.

### Disparo de Aviso

Habilidade Física, Ofensivo, Projétil.

**Precisão Difícil**, requer alguma **Arma de Longo Alcance** e **Custa** 6 pontos de **Mana**.
...
Pode ser usado apenas uma vez por **Plano** com **Precisão Garantida** em **Planos de Interpretação** fazendo com que você comece imediatamente o **Plano de Combate**, porém empurrando **Unidade** até **1d20** metros a partir de você.
...
A fraqueza de um corredor é o seu calcanhar. Realiza um **Ataque** contra o **Oponente**, aplicando **1d6** **Efeitos** de **Redução** de **Velocidade**. **Crítico** com essa **Habilidade** também aplicam 1 **Efeito** de **Enraizamento**.
