...
Você levanta uma esfera de água protetora para um aliado, além de curar as suas feridas. Em um **Aliado** adiciona 4 **Efeitos** de **Regeneração** e **Barreira**. Você recebe 4 **Efeitos** de **Desgaste**.

### Hiperfoco

Talento Mágico, Recuperação.

Sua concentração é incrível quando o assunto é magia. Aumenta o **Domínio** em 1. Todo fim de seu **Turno** você recupera 1 ponto de **Mana**, ou 2 se tiver igual ou mais da metade da **Mana** máxima.
...
Manipulando pequenos grãos no chão você os joga- magicamente pelo ar, dificultando a visão de oponentes e revelando inimigos furtivos. Em uma área ao seu redor, com raio igual ao seu **Atributo** de **Alcance**, todos **Oponentes** recebem **1d4** **Efeitos** de **Redução** de **Velocidade** e **Precisão**. **Oponentes** ocultos são revelados e voltam para o **Plano de Combate**, recebendo **1d6** de **Dano**.

### Reforço Positivo

Talento Mágico, Ofensivo e Recuperação.

Um feitiço bem executado sempre refresca a mente. Aumenta a **Maestria** em 1. Quando seus pontos de **Mana** estiverem abaixo da metade você tem um **Aumento** de 1 no **Crítico**. Acertos **Críticos** restauram 3 pontos de **Mana**.
...
**Precisão Normal** e **Custa** 13 pontos de **Mana**.

Um movimento de mão que impulsiona o ar e afasta todas as ameaças. Aplica **1d4** **Efeitos** de **Redução** de **Velocidade** em todos os **Oponentes** dentro de um raio igual ao seu **Alcance**. Você pode os empurrar para direção oposta em até, a sua escolha, a metade do seu **Alcance** arredondado para cima.
...
**Precisão Normal** e **Custa** 15 pontos de **Mana**.
...
Sua falta de paciência intensifica o uso do **Fogo**. Para **Magias de Fogo** o **Alcance**, **Crítico**, **Letalidade**, **Precisão** e **Maestria** são aumentadas em 1, além dos **Custos** de **Mana** desse **Tipo** também serem reduzidos em 1.
...
Ao encostar um dedo, mesmo que por pequenos instantes, você é capaz de congelar o que tocar. Adiciona 2 **Efeitos** de **Atordoamento** no **Alvo**. Você recebe 3 **Efeitos** de **Desgaste**.
...
Seu excesso de paciência intensifica o uso da **Água**. **Magias de Água** conjuradas sempre restauram 1 ponto de **Vida** de você e todos os **Aliados**, independente do seu **Alcance**, além dos **Custos** de **Mana** desse **Tipo** também serem reduzidos em 2.
...
Na sua presença o chão que sustenta seus oponentes torna-se traiçoeiro. Reduz o **Custo** de **Magias de Terra** em 3. Toda vez que um **Oponente** usar uma **Ação Principal** você pode o mover **1d4** metros após a sua **Ação** para qualquer direção em linha reta.
...
Frio e neve se concentram na palma da sua mão se tornando uma flecha pronta para atingir seu alvo. Essa **Habilidade** considera o dobro do seu **Atributo** de **Alcance**. Dispara um **Projétil** contra um **Inimigo** causando **1d8** de **Dano**, além **1d4** de **Efeitos** de **Redução** de **Velocidade**.
...
Há um vento misteriosos que te afasta de todas as ameaças. Reduz o **Custo** de **Magias de Vento** em 3. Toda vez que um **Oponente** usar uma **Ação Principal** você pode se mover **1d4** metros após a **Ação** dele, sem consumir nenhuma de suas **Ações** mas em linha reta.
...
**Precisão Normal** e **Custa** 30 pontos de **Mana**.
...
Você gira junto de um tornado, arremessando todos os oponentes ao ar. Aplica 3 **Efeitos** de **Banimento** em todos os **Oponentes** dentro de um raio igual ao seu **Alcance**. No final do **Banimento**, você pode escolher as novas posições do campo onde os **Oponentes** vão pousar, mas dentro do seu **Alcance**.
...
Uma corrente de água que cura os aliados, sendo também um meio de locomoção no mar. Restaura 2 pontos de **Vida** de um **Aliado** o aplicando 3 **Efeitos** de **Regeneração**. A **Cura**, **Efeitos** e a **Distância** são dobrados para um outro **Aliado** dentro desse novo **Alcance**, e assim por diante até um máximo de dois **Aliados** adicionais, sem repetir. Esses **Aliados** podem a sua escolha sofrer uma **Dissipação Normal** em todos os **Efeitos Negativos**. A **Maestria** também é duplicada. Você recebe 5 **Efeitos** de **Desgaste**.

Pode ser usado com **Precisão Garantida** e **Custo** 10 pontos de **Mana** em **Planos de Interpretação** e em um ambiente aquático para fazer você e todos os seus **Aliados** usarem uma viagem rápida para qualquer lugar daquele ambiente (inclusive outras **Zonas** e **Regiões** conhecidas se estiverem conectadas como por exemplo em rios e mares).
...
Abençoa um aliado com o poder do vento, dando a capacidade de planar levemente pelo ar sem uma queda brusca. Aplica em um **Aliado** 5 **Efeitos** de **Aumento** de **Esquiva** e 10 de **Aumento** de **Velocidade**. Você recebe 5 **Efeitos** de **Desgaste**.

Pode ser usado com **Precisão Garantida** e **Custo** 10 pontos de **Mana** em **Planos de Interpretação**  para fazer o **Aliado** planar, assim dando acertos **Garantidos** em **Ações Interpretativas** de **Movimentação**, ainda há arremesso de **Dado** para possibilidade de **Crítico**.

### Presença Infernal

Talento Mágico de Fogo, Aura, Ofensivo.

Os inimigos em sua presença ficam com uma visão turva e soam sem parar. Aumenta a **Maestria** em 2. No início do seu **Turno** sempre causa **1d4** pontos de **Dano** em todos os **Oponentes**, ignorando totalmente a **Defesa** e **Espírito** e não importando a distância. O **Dano** não escala com a **Maestria**.

### Presença Invernal

Talento Mágico de Água, Aura, Controle.

Os inimigos em sua presença tremem de frio e perdem a concentração aos poucos. Aumenta o **Espírito** em 2. No início do seu **Turno** os **Oponentes** sempre perdem **1d4** pontos de **Mana**, não importando a distância.
...
Em um piscar de olhos você se teletransporta para um novo local, deixando um rastro de destruição onde passou. Executa uma **Ação de Movimento** adicional, porém com a **Velocidade** somada ao **Alcance** e **Maestria**. Na trajetória, todos os **Oponente** que você passar sofrem **1d20** de **Dano**, ganhando 2 **Efeitos** de **Aumento** de **Velocidade** por **Oponente** atingido.
...
Você tenta usar o ambiente para afogar o oponente, mas caso não haja o ambiente ideal, você o cria lentamente. Essa **Habilidade** só pode ser usada contra um **Oponente** que não seja um **Chefe**, além de ser do mesmo **Nível** ou inferior ao seu e também estar em um ambiente aquático. o **Alvo** é executado se for um **Oponente**.
...
**Precisão Improvável** e **Custa** 49 pontos de **Mana**.
...
**Precisão Difícil** e **Custa** 35 pontos de **Mana**.
...
Os inimigos em sua presença não ousam te contestar. Aumenta a **Defesa** em 1 e **Espírito** em 6. Desde o início do seu **Turno** os **Oponentes** não podem te interromper, isso só ocorre em seus **Turnos** ímpares e não importando a distância.

### Presença Volátil

Talento Mágico de Vento, Aura, Controle.

Os inimigos em sua presença não conseguem te acertar. Aumenta a **Esquiva** em 1 e **Velocidade** em 2. Desde o início do **Turno** dos **Oponentes** eles tem a metade da **Precisão** contra você, isso só ocorre em seus **Turnos** ímpares não importando a distância.
...
Um furacão que surge e se mantém destruindo tudo que toca. Escolhe um **Local** quadrado, em qualquer lugar do campo de batalha mas com medidas igual o seu **Alcance**, onde causa **1d12** de **Dano** imediatamente. Você pode manter aquele **Local** gastando 5 pontos de **Mana** no começo de cada um de seus **Turnos**, assim causando **1d6** de **Dano** em **Oponentes** que estiverem em cima, além de terem a **Velocidade** reduzida em 6.
...
Em alguns momentos você consegue usar o fogo da sua forma mais concentrada. Aumenta a **Maestria** em 3. Nos seus **Turnos** pares as **Magias de Fogo** se tornam azuis, fazendo que quando acertem sempre sejam **Crítico**.
...
Magia de Água, Local, Ofensivo.

**Precisão Garantida** e **Custa** 75 pontos de **Mana**.

Uma catástrofe que inunda todo o cenário. Torna o campo de batalha inteiro em um ambiente aquático, onde todos os **Oponente** submersos que não possam respirar recebem 3 **Efeitos** de **Sangramento** por **Turno**. A altura do ambiente pode ser o dobro do seu **Alcance**, **Domínio** ou **Maestria** a sua escolha. **Oponentes** em cima da inundação não são mais considerados submersos ou em ambiente aquático. **Oponentes** podem em suas **Ações de Movimento** sacrificar o movimento horizontal para nadar verticalmente, para assim poderem chegar a superfície.

**Inundar** só pode ser usada uma vez por **Sessão**, o nível da água é reduzida em 5 cada **Turno** seu, sempre sendo finalizado se for inferior a 5 metros de altura.

### Poça Vermelha

Talento Mágico de Água, Recuperação.

Em alguns momentos você consegue interpretar o sangue como água. Seus pontos de **Domínio** concedem 1 de **Mana** máximo adicional. **Oponentes** que sofrerem **Dano** por você deixam uma poça de sangue no chão, uma **Estrutura** única com **Marcadores** igual a metade do **Dano** que ele sofreu, arredondado para cima. Se um **Oponente** em cima de uma poça sofrer **Dano**, ao invés de criar uma nova poça de sangue a atual ira receber esses novos **Marcadores** além ter os seus atuais. **Aliados** que passarem por cima de poças de sangue podem as sacrificar para recuperar pontos de **Vida** igual aos **Marcadores** da estrutura.
...
A representação mais próxima de **Gaia**. Invoca uma **Unidade** de terra em forma de uma grande tartaruga. Ela possui uma ficha própria como um **Jogador**, com **3d20** pontos de **Atributo Primário** para distribuir, além de estar sobre seu controle e poder usar todas **Magias de Terra** que você tem, também tendo os **Talentos Mágicos de Terra** que você tem.
...
O ar que você respira se torna diabólico, diminuindo o foco de seus adversários. Aumenta o **Espírito** em 4. **Oponentes** dentro de um raio igual ao o dobro de seu **Alcance** tem os **Custos** de **Mana** dobrados. Não se aplica a **Chefes**.

### Poeira Clara

Talento Mágico de Terra, Aura, Recuperação.

A terra que você pisa se torna perto do divino, aumentando a concentração de seus aliados. Aumenta a **Sorte** em 10. **Aliados** dentro de um raio igual ao o dobro de seu **Alcance** tem os **Custos** de **Mana** reduzidos pela metade. Não se aplica a você.
...
A sua instabilidade de tantos elementos da natureza diferentes finalmente foi contida. Aumenta a **Inteligência** em 7. Seu **Talento Principal** de **Instabilidade** perde o **Custo** de **Mana** adicional e não é mais limpo ao repetir o mesmo **Elemento**.

### Maestria Familiar

Talento Mágico, Invocação.

Como uma verdadeira lenda da magia você é capaz de controlar cada senhor dos elementos. Aumenta a **Agilidade**, **Força** e **Inteligência** em 2. Seus **Familiares** não tem mais duração, e são reinvocados automaticamente no próximo **Plano**, sem gastar **Mana**, caso sejam eliminados.