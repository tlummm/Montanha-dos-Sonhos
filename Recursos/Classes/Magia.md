...
O controle de diversos elementos da natureza sobrecarregam a sua **Mana**, tornando as magias mais poderosas assim como instáveis. Ao usar uma **Habilidade** você anota o seu **Elemento** e aumenta a seu **Alcance** e **Maestria** permanentemente em um valor igual ao seu **Nível** até o fim do **Plano**. O custo de **Mana** de suas **Magias** também é aumentado no mesmo valor.

Quando anotar novamente o mesmo **Elemento** todas as anotações são limpas, além de seu **Alcance**, **Maestria** e **Custos** adicionais por este **Talento** serem perdidos.
...
Sua concentração é incrível quando o assunto é magia. Aumenta o **Alcance** e **Domínio** em 1. Todo fim de seu **Turno** você recupera 1 ponto de **Mana**, ou 2 se tiver igual ou mais da metade da **Mana** máxima.
...
Um feitiço bem executado sempre refresca a mente. Aumenta o **Espírito** e **Maestria** em 1. Quando seus pontos de **Mana** estiverem abaixo da metade você tem um **Aumento** de 1 no **Crítico**. Acertos **Críticos** restauram 3 pontos de **Mana**.
...
Sua falta de paciência intensifica o uso do **Fogo**. Aumenta o **Alcance** e **Maestria** em 1. Para **Magias de Fogo** o **Alcance**, **Crítico**, **Letalidade**, **Precisão** e **Maestria** também são aumentadas em 1, além dos **Custos** de **Mana** desse **Tipo** também serem reduzidos em 2.
...
Seu excesso de paciência intensifica o uso da **Água**. Aumenta o **Espírito** e **Vigor** em 1. **Magias de Água** conjuradas sempre restauram 1 ponto de **Vida** de você e todos os **Aliados**, independente do seu **Alcance**, além dos **Custos** de **Mana** desse **Tipo** também serem reduzidos em 2.
...
Na sua presença o chão que sustenta seus oponentes torna-se traiçoeiro. Aumenta a **Defesa** em 2 e o **Espírito** em 1. Reduz o **Custo** de **Magias de Terra** em 3. Toda vez que um **Oponente** usar uma **Ação Principal** você pode o mover **1d4** metros após a sua **Ação** para qualquer direção em linha reta.

### Pilastra

Magia de Terra, Local, Controle e Ofensivo.

**Precisão Improvável** e **Custa** 19 pontos de **Mana**.
...
Há um vento misteriosos que te afasta de todas as ameaças. Aumenta o **Alcance** e **Velocidade** em 2. Reduz o **Custo** de **Magias de Vento** em 3. Toda vez que um **Oponente** usar uma **Ação Principal** você pode se mover **1d4** metros após a **Ação** dele, sem consumir nenhuma de suas **Ações** mas em linha reta.
...
**Precisão Normal** e **Custa** 27 pontos de **Mana**.
...
**Precisão Normal** e **Custa** 18 pontos de **Mana**.
...
A astúcia do seu poder de vento é tão sagaz que as vezes escapam algumas correntes de ar mesmo que esteja conjurando um outro elemento. Aumenta o **Espírito** em 3 e a **Velocidade** em 2. Sempre que você usar uma **Magia**, não importando qual **Elemento**, você e seus **Aliados** recebem 2 **Efeitos** de **Aumento** de **Velocidade**.
...
A disciplina do seu poder de Terra é tão rígida que as vezes escapam alguns pequenos terremotos mesmo que você esteja conjurando um outro elemento. Aumenta a **Defesa** em 2 e o **Espírito** em 3. Sempre que você usar uma **Magia**, não importando qual **Elemento**, os **Oponentes** recebem 2 **Efeitos** de **Redução** de **Velocidade**.
...
Abençoa um aliado com o poder do vento, dando a capacidade de planar levemente pelo ar sem uma queda brusca. Aplica em um **Aliado** 6 **Efeitos** de **Aumento** de **Esquiva** e 0 de **Aumento** de **Velocidade**. Você recebe 3 **Efeitos** de **Desgaste**.
...
Os inimigos em sua presença ficam com uma visão turva e soam sem parar. Aumenta o **Domínio** em 3 e a **Maestria** em 2. No início do seu **Turno** sempre causa **1d4** pontos de **Dano** em todos os **Oponentes**, ignorando totalmente a **Defesa** e **Espírito** e não importando a distância. O **Dano** não escala com a **Maestria**.

### Presença Invernal

Talento Mágico de Água, Aura, Controle.

Os inimigos em sua presença tremem de frio e perdem a concentração aos poucos. Aumenta o **Domínio** em 3 e o **Espírito** em 2. No início do seu **Turno** os **Oponentes** sempre perdem **1d4** pontos de **Mana**, não importando a distância.
...
**Precisão Difícil** e **Custa** 23 pontos de **Mana**.
...
**Precisão Difícil** e **Custa** 19 pontos de **Mana**.
...
**Precisão Improvável** e **Custa** 45 pontos de **Mana**.
...
Os inimigos em sua presença não conseguem te acertar. Aumenta a **Esquiva** em 1 e **Velocidade** em 3. Desde o início do **Turno** dos **Oponentes** eles tem a metade da **Precisão** contra você, isso só ocorre em seus **Turnos** ímpares não importando a distância.
...
Em alguns momentos você consegue usar o fogo da sua forma mais concentrada. Aumenta a **Maestria** em 6. Nos seus **Turnos** pares as **Magias de Fogo** se tornam azuis, fazendo que quando acertem sempre sejam **Crítico**.
...
O ar que você respira se torna diabólico, diminuindo o foco de seus adversários. Aumenta o **Espírito** em 7. **Oponentes** dentro de um raio igual ao o dobro de seu **Alcance** tem os **Custos** de **Mana** dobrados. Não se aplica a **Chefes**.

### Poeira Clara

Talento Mágico de Terra, Aura, Recuperação.

A terra que você pisa se torna perto do divino, aumentando a concentração de seus aliados. Aumenta a **Sorte** em 15. **Aliados** dentro de um raio igual ao o dobro de seu **Alcance** tem os **Custos** de **Mana** reduzidos pela metade. Não se aplica a você.
...
A sua instabilidade de tantos elementos da natureza diferentes finalmente foi contida. Aumenta a **Inteligência** em 9. Seu **Talento Principal** de **Instabilidade** perde o **Custo** de **Mana** adicional e não é mais limpo ao repetir o mesmo **Elemento**.

### Maestria Familiar

Talento Mágico, Invocação.

Como uma verdadeira lenda da magia você é capaz de controlar cada senhor dos elementos. Aumenta a **Agilidade**, **Força** e **Inteligência** em 3. Seus **Familiares** não tem mais duração, e são reinvocados automaticamente no próximo **Plano**, sem gastar **Mana**, caso sejam eliminados.