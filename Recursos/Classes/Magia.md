...
O controle de diversos elementos da natureza sobrecarregam a sua **Mana**, tornando as magias mais poderosas assim como instáveis. Ao usar uma **Habilidade** você anota o seu **Elemento** e aumenta a seu **Espírito** e **Maestria** permanentemente em um valor igual ao seu **Nível** até o fim do **Plano**. O custo de **Mana** de suas **Magias** também é aumentado no mesmo valor.

Quando anotar novamente o mesmo **Elemento** todas as anotações são limpas, além de seu **Espírito**, **Maestria** e **Custos** adicionais por este **Talento** serem perdidos.
...
Sua concentração é incrível quando o assunto é magia. Aumenta o **Domínio** em 2. Todo fim de seu **Turno** você recupera 1 ponto de **Mana**.
...
Chamas se concentram na palma da sua mão se tornando uma flecha pronta para atingir seu alvo. Dispara um **Projétil** contra um **Inimigo** causando **1d6** de **Dano** e **Efeitos** de **Sangramento**.

A primeira **Seta de Fogo** conjurada por você em cada **Combate** tem 1 de **Crítico** e **Precisão** adicional.
...
**Precisão Improvável** e **Custa** 18 pontos de **Mana**.
...
**Precisão Normal** e **Custa** 26 pontos de **Mana**.
...
**Precisão Normal** e **Custa** 17 pontos de **Mana**.
...
**Precisão Difícil** e **Custa** 18 pontos de **Mana**.
...
**Precisão Difícil** e **Custa** 32 pontos de **Mana**.
...
Em alguns momentos você consegue usar o fogo da sua forma mais concentrada. Seus **Críticos** usam metade da **Maestria** como **Dano Mágico** adicional. Nos seus **Turnos** pares as **Magias de Fogo** se tornam azuis, fazendo que quando acertem sempre sejam **Crítico**.
...
**Precisão Garantida** e **Custa** 70 pontos de **Mana**.
...
O poder quase divino de criar um inferno. Essa **Habilidade** só pode ser usada em uma **Zona** completamente conquistada (**Chefes** e **Masmorras** concluídas, além de todos os locais visitados). O **Local** é completamente apagado e substituído por uma **Zona** de um dos seis [[Abismos__]] a sua escolha. Novos **Monstros**, **Itens**, **Recursos** e **Chefes** surgem desse local baseado em seu **Nível**. **Masmorras** não são criadas, mas ainda há **Oponentes** de **Elite**.
...
O poder quase divino de criar um mar. Essa **Habilidade** só pode ser usada em uma **Zona** completamente conquistada (**Chefes** e **Masmorras** concluídas, além de todos os locais visitados). O **Local** é completamente apagado e substituído por uma **Zona** de um dos nove [[Grandes Mares__]] a sua escolha. Novos **Monstros**, **Itens**, **Recursos** e **Chefes** surgem desse local baseado em seu **Nível**. **Masmorras** não são criadas, mas ainda há **Oponentes** de **Elite**.
...
O poder quase divino de criar um reino. Essa **Habilidade** só pode ser usada em uma **Zona** completamente conquistada (**Chefes** e **Masmorras** concluídas, além de todos os locais visitados). O **Local** é completamente apagado e substituído por uma **Zona** de um dos nove [[Reinos__]] a sua escolha. Novos **Monstros**, **Itens**, **Recursos** e **Chefes** surgem desse local baseado em seu **Nível**. **Masmorras** não são criadas, mas ainda há **Oponentes** de **Elite**.
