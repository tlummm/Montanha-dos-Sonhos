...
É necessário cuidado para não deixar nada cair. Oferece 5 espaços de **Item** no **Inventário**, porém perde 1 de **Velocidade** e 1 de **Alcance** para cada **Item** armazenado nessa **Mochila**.
...
Um forma robusta de guardar suas coisas, mas ainda é pesada. Oferece 5 espaços de **Item** no **Inventário**, porém perde 1 de **Velocidade** para cada **Item** armazenado nessa **Mochila**.
...
As técnicas e tecnologias por trás dessa obra prima fazem ela parecer mais leve a medida do aumento de seu peso. Oferece 5 espaços de **Item** no **Inventário**, aumentando a **Velocidade** em 1 para cada **Item** armazenado nela.
...
Leigos não sabem dizer se é uma armadura ou traje mágico, mas sim que é feito apenas para destruir. Cada parte aumenta **Alcance**, **Defesa** e **Maestria** em 1.
...
Para o pão e circo completo os lutadores da arena se importam apenas com o ataque. Cada parte aumenta **Ataque**, **Letalidade** e **Maestria** em 1.

Conjunto Completo: Ganha **Maestria** igual a metade do seu **Atributo** de **Ataque**, arredondado para cima.
...
Trapos de tecidos tão escuros quanto a noite tornando-se um com a sombra. Cada parte aumenta o **Ataque**, **Letalidade** e **Velocidade** em 1.
...
Um pequeno bolso bordado a tecido etéreo, alterando o espaço para seus fins. Oferece 10 espaços de **Item** no **Inventário**, porém aumenta o espaço em 1 para cada **Item** que não repetir todos os seus **Tipos** com todos de outro.

### Cartola Mágica

Equipamento Mágico, Elmo ou Mochila.

O primeiro magico a tirar um coelho da cartola evoluiu seu truque um pouco de mais. Esse **Item** pode ser equipado de ambas as formas. Oferece 10 espaços de **Item** no **Inventário**. **Monstros** de **Nível** 6 ou inferior podem ser armazenados ao **Toque**, como uma **Habilidade**, e invocados destes espaços, mas não necessariamente sobre seu controle.

### Conjunto: Quimono do Campeão Clandestino

Equipamentos Mágicos, Compostos por: Elmo, Torso, Ombreiras, Mãos, Pernas, Pés.

Mesmo sendo um traje formal sua composição mágica transforma a intenção de seu portador em poder. Cada parte aumenta o **Ataque** em 2 e a **Defesa** em 1.
...
Os diretores da **Academia Violeta** costumam trapacear em jogos. Cada parte aumenta o **Alcance**, **Domínio** e **Maestria** em 2.
...
Os mortais entenderam que para caçar os **Primordiais** deveriam lidar com sua invencibilidade. Cada parte aumenta o **Ataque**, **Maestria** e **Letalidade** em 2.
...
O sonho de um colecionador é uma fera lendária em seu cárcere. Esse **Item** não pode ser equipado em você, **Jogadores** ou **NPCs**. Você pode usar ele do seu **Inventário**, como uma **Habilidade**, para equipar ao **Toque** em um **Monstro** de **Nível** 6 ou inferior. Enquanto equipado você controla aquele **Monstro**.
...
As lendas dizem que os grandes criadores carregavam mundos em seus bolsos. Oferece 20 espaços de **Item** no **Inventário**. Você pode armazenar **Estruturas** nos espaços deste **Item**.

### Gaiola do Colecionador

Equipamento Lendário, Costas.

Quem vê de fora não imagina que é um doce lar. Aumenta a **Liderança** em 30. Pode armazenar um **Monstro** de **Nível** 9 ou inferior ao **Toque** como uma **Habilidade**. **Monstros** que já foram armazenados são mais suscetíveis as suas **Ações de Interpretação**, com um aumento de 2.

### Mandíbula Dracônica

Equipamento Lendário, Mãos.

O dragão vivo nesse manopla estende suas juntas mágicas para sempre alcançar seus alvos. Aumenta o **Ataque** e a **Velocidade** em 10. **Alcance** de **Toque** é aumentado em 5. Concede um **Ataque Básico** adicional por **Turno** e os **Ataques** adicionais causam o mesmo **Dano** em um **Alvo** adicional.
...
O toque dos dedos dessa luva costumam enfeitiçar seus inimigos transformando-os em criaturas asquerosas. Aumenta o **Domínio** e **Maestria** em 10. A primeira vez que um **Oponente** sofrer **Dano** seu ele recebe 1 **Efeito** de **Polimorfia**, virando um **Monstro** aleatória de **Nível** 6.
...
Na ausência do grande sol os deuses precisaram criar uma nova alternativa. Aumenta a **Precisão** em 10 durante o **Dia** e a **Esquiva** em 10 durante a **Noite**.

### Caixa de Armamentos

Equipamento Divino, Mochila.

O ferreiro louco criou uma forma de poder armazenar suas obras primas. Oferece 20 espaços de **Item** no **Inventário**. Você pode armazenar **Armas** e **Equipamentos** sem ocupar os espaços, assim sendo infinito.

### Colete Alquímico

Equipamento Divino, Torso.

O mais próximo que os alquimistas chegaram do deus de todo o ouro deste mundo. Toda vez que sofrer **Dano**, que não seja de **Efeitos**, um quarto é absorvido e convertido para **Moedas de Ouro**, arredondado para cima.
...
Criada para governar todos os mortais. Você não pode usar **Habilidades** mas também não pode sofrer **Habilidades**. Todos os **NPCs** e **Monstros** do mundo, sendo de **Nível** 6 ou inferior, estão sob seu controle.
...
Uma invisibilidade tão forte que completamente apaga a existência. Aumenta a **Esquiva** em 10. Sua localização não é revelada para **Oponentes**. Você não pode ser **Alvo** de **Ataques** ou **Habilidades** com as seguintes **Áreas de Efeito**: **Toque**, **Projétil** e **Individual**.
